...
import com.amarlabs.maps.GPSTracker;
import com.amarlabs.maps.MarkerContent;
...
//            radius = Double.parseDouble(bundle.getString("radius")) * 1000 ; //Extract the data
            radius = 5.0 * 1000 ; //Extract the data
        ...
        private void setBloodGroupSpinnerContent() {
            ...
            bloodGroupSpinner = (Spinner) this.findViewById( R.id.bloodGroup);
        ...
        public boolean onCreateOptionsMenu(Menu menu) {
            ...
            getMenuInflater().inflate(R.menu.menu_plot_location, menu);
            return true;
        }
